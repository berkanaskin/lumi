...
const NETFLIX     = { tmdb_id: 8,    sa_id: 'netflix',     name: 'Netflix',     slug: 'netflix',     logo_path: '/img/providers/netflix.webp' };
const DISNEY_PLUS = { tmdb_id: 337,  sa_id: 'disney',      name: 'Disney+',     slug: 'disney-plus', logo_path: '/img/providers/disney-plus.webp' };
const PRIME       = { tmdb_id: 119,  sa_id: 'prime',       name: 'Amazon Prime Video', slug: 'prime-video', logo_path: '/img/providers/prime-video.webp' };
const APPLE_TV    = { tmdb_id: 350,  sa_id: 'apple',       name: 'Apple TV+',   slug: 'apple-tv-plus', logo_path: '/img/providers/apple-tv-plus.webp' };
const MUBI        = { tmdb_id: 11,   sa_id: 'mubi',        name: 'MUBI',        slug: 'mubi',        logo_path: '/img/providers/mubi.webp' };
const CRUNCHYROLL = { tmdb_id: 283,  sa_id: 'crunchyroll', name: 'Crunchyroll', slug: 'crunchyroll', logo_path: '/img/providers/crunchyroll.webp' };
const MAX_GLOBAL  = { tmdb_id: 1899, sa_id: 'hbo',         name: 'Max',         slug: 'max',         logo_path: '/img/providers/max.png' };
const PARAMOUNT   = { tmdb_id: 531,  sa_id: 'paramount',   name: 'Paramount+',  slug: 'paramount-plus', logo_path: '/img/providers/paramount-plus.webp' };
const HULU        = { tmdb_id: 15,   sa_id: 'hulu',        name: 'Hulu',        slug: 'hulu',        logo_path: '/img/providers/hulu.webp' };
const PEACOCK     = { tmdb_id: 386,  sa_id: 'peacock',     name: 'Peacock',     slug: 'peacock',     logo_path: '/img/providers/peacock.webp' };
...
export const REGION_PLATFORMS = {
    ...
    TR: [
        ...
        { tmdb_id: 1899, sa_id: 'hbo',     name: 'HBO Max',     slug: 'hbo-max',     logo_path: '/img/providers/hbo-max.webp', preSelected: false },
    ...
    GB: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 38,   sa_id: 'iplayer',   name: 'BBC iPlayer', slug: 'bbc-iplayer', logo_path: '/img/providers/bbc-iplayer.webp', preSelected: false },
        { tmdb_id: 39,   sa_id: 'now',       name: 'NOW TV',      slug: 'now-tv',      logo_path: '/img/providers/now-tv.webp',     preSelected: false },
        { ...APPLE_TV,   preSelected: false },
        { tmdb_id: 29,   sa_id: 'sky',       name: 'Sky Go',      slug: 'sky-go',      logo_path: '/img/providers/sky-go.png',      preSelected: false },
        { tmdb_id: 1796, sa_id: 'itvx',      name: 'ITVX',        slug: 'itvx',        logo_path: '/img/providers/itvx.webp',       preSelected: false },
        { tmdb_id: 151,  sa_id: 'britbox',   name: 'BritBox',     slug: 'britbox',     logo_path: '/img/providers/britbox.webp',    preSelected: false },
        { ...MUBI,       preSelected: false },
    ...
    DE: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 29,   sa_id: 'wow',     name: 'WOW',          slug: 'wow',         logo_path: '/img/providers/wow.webp',        preSelected: false },
        { tmdb_id: 298,  sa_id: 'rtlplus', name: 'RTL+',         slug: 'rtl-plus',    logo_path: '/img/providers/rtl-plus.webp',   preSelected: false },
        { tmdb_id: 178,  sa_id: 'joyn',    name: 'Joyn',         slug: 'joyn',        logo_path: '/img/providers/joyn.webp',       preSelected: false },
        { ...APPLE_TV,   preSelected: false },
        { tmdb_id: 532,  sa_id: 'magenta', name: 'Magenta TV',   slug: 'magenta-tv',  logo_path: '/img/providers/magenta-tv.webp', preSelected: false },
        { ...MUBI,       preSelected: false },
        { ...CRUNCHYROLL, preSelected: false },
    ],
    ...
    FR: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 381, sa_id: 'canalplus', name: 'Canal+',     slug: 'canal-plus',  logo_path: '/img/providers/canal-plus.webp', preSelected: false },
        { tmdb_id: 78,  sa_id: 'mycanal',   name: 'myCANAL',    slug: 'mycanal',     logo_path: '/img/providers/mycanal.png',    preSelected: false },
        { tmdb_id: 56,  sa_id: 'ocs',       name: 'OCS',        slug: 'ocs',         logo_path: '/img/providers/ocs.webp',       preSelected: false },
        { ...APPLE_TV,  preSelected: false },
    ...
    IT: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 39,   sa_id: 'now',      name: 'NOW',              slug: 'now-it',       logo_path: '/img/providers/now-tv.webp',        preSelected: false },
        { ...APPLE_TV,   preSelected: false },
    ...
    JP: [
        ...
        { tmdb_id: 84,   sa_id: 'unext',  name: 'U-NEXT',      slug: 'u-next',       logo_path: '/img/providers/u-next.webp',      preSelected: false },
        { ...APPLE_TV,   preSelected: false },
        ...
        { tmdb_id: 2241, sa_id: 'abema',  name: 'ABEMA',       slug: 'abema',        logo_path: '/img/providers/abema.webp',       preSelected: false },
        { ...CRUNCHYROLL, preSelected: false },
    ],
    ...
    KR: [
        { ...NETFLIX,     preSelected: true },
        { ...DISNEY_PLUS, preSelected: true },
        { tmdb_id: 356,  sa_id: 'wavve',       name: 'Wavve',        slug: 'wavve',        logo_path: '/img/providers/wavve.webp',       preSelected: false },
        { tmdb_id: 1947, sa_id: 'tving',       name: 'TVING',        slug: 'tving',        logo_path: '/img/providers/tving.webp',       preSelected: false },
    ...
    CA: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 230, sa_id: 'crave',  name: 'Crave',      slug: 'crave',      logo_path: '/img/providers/crave.webp',     preSelected: false },
        { ...APPLE_TV,  preSelected: false },
    ...
    AU: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 132, sa_id: 'stan',     name: 'Stan',           slug: 'stan',           logo_path: '/img/providers/stan.webp',          preSelected: false },
        { tmdb_id: 87,  sa_id: 'binge',    name: 'Binge',          slug: 'binge',          logo_path: '/img/providers/binge.webp',         preSelected: false },
        { ...APPLE_TV,  preSelected: false },
    ...
    BR: [
        ...
        { ...DISNEY_PLUS, preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 307, sa_id: 'globoplay', name: 'Globoplay',   slug: 'globoplay',  logo_path: '/img/providers/globoplay.webp', preSelected: false },
        { ...APPLE_TV,   preSelected: false },
        { ...MAX_GLOBAL, preSelected: false },
    ...
    IN: [
        { ...NETFLIX,     preSelected: true },
        { ...PRIME,       preSelected: true },
        { tmdb_id: 122, sa_id: 'hotstar',  name: 'Disney+ Hotstar', slug: 'hotstar',  logo_path: '/img/providers/hotstar.webp',  preSelected: false },
        { tmdb_id: 232, sa_id: 'zee5',     name: 'Zee5',            slug: 'zee5',     logo_path: '/img/providers/zee5.webp',     preSelected: false },
        { tmdb_id: 237, sa_id: 'sonyliv',  name: 'SonyLIV',         slug: 'sonyliv',  logo_path: '/img/providers/sonyliv.webp',  preSelected: false },
        { tmdb_id: 220, sa_id: 'jiocinema', name: 'JioCinema',      slug: 'jiocinema', logo_path: '/img/providers/jiocinema.webp', preSelected: false },
        { ...APPLE_TV,  preSelected: false },
        { ...CRUNCHYROLL, preSelected: false },
        { ...MUBI,      preSelected: false },
    ],
